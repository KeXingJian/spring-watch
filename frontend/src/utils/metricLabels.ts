...
export const INFRA_LABELS: Record<string, string> = {
  ...
  'broker.produce_conversions_rate': 'Broker 消息格式转换速率',
  ...
  'broker.partitions': 'Broker Partition 总数',
  'broker.leaders': 'Broker Leader 数',
  ...
  'broker.jvm.process_cpu_load': 'Broker 进程 CPU 负载',
  'broker.jvm.system_cpu_load': 'Broker 系统 CPU 负载',
  'broker.jvm.load_average': 'Broker 系统负载均值',
  'broker.jvm.thread_count': 'Broker JVM 线程数',
